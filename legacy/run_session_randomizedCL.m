...
saveFolder = ['H:\.shortcut-targets-by-id\10pxdlRXtzFB-abwDGi0jOGOFFNm3pmFK\Tuthill Lab Shared\Yichen\', ...
                    'Spiracle\Flight_Arena_Data\250623_SpMN4_CsChR_ChATGAL80\'];
...
experiment_name = 'SpMN4_CsChR_ChATGAL80';     % Example: spSN_ChR
genotype = 'IS76603_6d_F';             % Example: SS48339_2d_M
flyNumber = 'Fly3';                 % Example: Fly1
trialNum = 'Trial1';
stimulus_regime = '0-3000ms';   % Example: 0-3000ms
stimulus_position = 'thorax';
%% Construct FlyType
FlyType = [experiment_name '_' genotype '_' flyNumber '_' trialNum '_' stimulus_regime '_' stimulus_position];
